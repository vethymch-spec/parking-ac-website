...
function collectStaticUrls() {
  return [
    ...
    `https://${HOST}/vehicle-compatibility`,
    `https://${HOST}/vehicle-compatibility/semi-truck-parking-ac`,
    `https://${HOST}/vehicle-compatibility/rv-parking-ac`,
    `https://${HOST}/vehicle-compatibility/12v-vs-24v-parking-ac`,
    `https://${HOST}/dealer-guide/parking-ac-local-market-fitment`,
    `https://${HOST}/blog`,
    `https://${HOST}/about`,
    `https://${HOST}/contact`,
