...
const searchableItems: SearchItem[] = [
  ...
  },
  {
    ...
    subtitle: "Check parking AC fitment by vehicle type, voltage, roof space, and battery runtime",
    href: "/vehicle-compatibility",
    keywords: ["compatibility", "fitment", "vehicle", "12v", "24v", "roof", "dealer", "semi truck", "rv", "van", "pickup"],
  },
  {
    type: "page",
    title: "Truck Air Conditioner & Truck AC Guide",
    subtitle: "Route truck AC, semi truck air conditioner, truck cab AC, and portable truck AC searches",
    href: "/solutions/truck-ac",
    keywords: ["truck air conditioner", "truck ac", "truck ac unit", "semi truck air conditioner", "ac for truck", "truck cab air conditioner"],
  },
  {
    type: "page",
    title: "12V Air Conditioner Guide",
    subtitle: "Compare 12V AC unit, 12 volt air conditioner, DC AC, rooftop, mini split, and portable searches",
    href: "/solutions/12v-air-conditioner",
    keywords: ["12v air conditioner", "12v ac unit", "12 volt air conditioner", "12 volt ac", "12v dc air conditioner", "battery powered air conditioner"],
  },
  {
    type: "page",
    title: "12V RV Air Conditioner Guide",
    subtitle: "Battery-powered RV AC planning for campers, caravans, motorhomes, rooftops, and off-grid use",
    href: "/solutions/12v-rv-air-conditioner",
    keywords: ["12v rv air conditioner", "12 volt rv air conditioner", "12v rv ac", "12v camper air conditioner", "12 volt air conditioner for camper", "12v rv rooftop air conditioner"],
  },
  {
    type: "page",
    title: "12V Air Conditioner for Van Guide",
    subtitle: "Compact van, campervan, cargo van, and service vehicle DC cooling guidance",
    href: "/solutions/12v-air-conditioner-for-van",
    keywords: ["12v air conditioner for van", "12 volt air conditioner for van", "van air conditioner 12v", "campervan aircon 12v", "12v ac unit for van", "ac for cargo van"],
  },
  {
    type: "page",
    title: "Portable AC for Truck Guide",
    subtitle: "Compare portable truck AC searches with mounted 12V/24V no-idle parking AC systems",
    href: "/solutions/portable-ac-for-truck",
    keywords: ["portable ac for truck", "portable air conditioner for truck", "portable ac for semi truck", "portable ac unit for truck drivers", "12v portable ac", "best portable ac for truck"],
  },
  {
    type: "page",
    title: "Dealer Local Market Fitment Guide",
    subtitle: "Choose parking AC starter products by local customer vehicles and market demand",
    href: "/dealer-guide/parking-ac-local-market-fitment",
    keywords: ["dealer", "distributor", "wholesale", "local market", "fitment", "inventory", "parking ac business"],
  },
  {
    type: "page",
  ...
  },
  {
    ...
    subtitle: "30-day return and refund policy",
    href: "/return-policy",
  ...
  },
  {
    ...
    subtitle: "Shipping timelines, delivery coordination, and order handling after invoice confirmation.",
    href: "/shipping-policy",
    keywords: ["shipping", "delivery", "tracking", "order handling"],
  },
  {
    type: "page",
